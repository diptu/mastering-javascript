...
const Products = ({ id, name, description, imgUrl, price, isAvailable, pCount }) => {



    return (

        <li class="list-group-item" style={{ backgroundColor: isAvailable ? 'white' : '#D3D3D3' }}>
            <div class="media align-items-lg-center flex-column flex-lg-row p-3 d-flex">
                <div class="media-body order-2 order-lg-1">
                    ...
                    <ProductDetails price={price} isAvailable={isAvailable} pCount={pCount} />
